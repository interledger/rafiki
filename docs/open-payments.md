...
The specification version that Rafiki uses is configured in [fetch-schemas.sh](../scripts/fetch-schemas.sh). Currently, it is using the tagged version v1.0 [v1.0](https://github.com/interledger/open-payments/tree/v1.0/openapi).
