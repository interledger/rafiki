...
| `PAYMENT_POINTER_DEACTIVATION_PAYMENT_GRACE_PERIOD` | `86400000`                                                  | Milliseconds into the future to set expiration of open incoming payments when deactivating payment pointer |
