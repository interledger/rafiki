...
All data stays with the ASE, minus optional [telemetry](telemetry) data that's aggregated and pushed to the Interledger Foundation. Rafiki holds no source-of-truth data, personal or otherwise.
