...
All data stays with the FSP, minus optional [telemetry](/overview/concepts/telemetry) data that's aggregated and pushed to the Interledger Foundation. Rafiki holds no source-of-truth data, personal or otherwise.
