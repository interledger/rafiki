...
:::note
The Interledger Foundation initially used Amazon-hosted Grafana which didn't meet our needs for embedding dashboards. Grafana Cloud offers a feature called _public dashboards_ which allows us to share dashboards. However, embedding may still pose a challenge.
:::
