...
<div class='wide-table'>
  ...
  | `LIVENET` | Boolean | Determines where to send metrics. Defaults to `false`, resulting in metrics being sent to thetestnet OTEL Collector.{' '} <p>Set to `true` on production environments dealing with real money.</p> | N |
