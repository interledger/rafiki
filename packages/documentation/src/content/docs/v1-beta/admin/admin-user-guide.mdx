...
<LargeImg
  src='/img/v1-beta/admin-guide/account-settings.png'
...
<LargeImg
  src='/img/v1-beta/admin-guide/home.png'
...
<LargeImg
  src='/img/v1-beta/admin-guide/peers.png'
...
<LargeImg
  src='/img/v1-beta/admin-guide/create-peer.png'
...
<LargeImg
  src='/img/v1-beta/admin-guide/edit-peer.png'
...
<img
  src='/img/v1-beta/admin-guide/delete-peer.png'
...
<LargeImg
  src='/img/v1-beta/admin-guide/assets.png'
...
<LargeImg
  src='/img/v1-beta/admin-guide/create-asset.png'
...
<LargeImg
  src='/img/v1-beta/admin-guide/edit-asset.png'
...
<LargeImg
  src='/img/v1-beta/admin-guide/wallet-addresses.png'
...
<LargeImg
  src='/img/v1-beta/admin-guide/create-wallet-address.png'
...
<LargeImg
  src='/img/v1-beta/admin-guide/edit-wallet-address.png'
...
<LargeImg
  src='/img/v1-beta/admin-guide/webhooks.png'
...
<LargeImg
  src='/img/v1-beta/admin-guide/payments.png'
