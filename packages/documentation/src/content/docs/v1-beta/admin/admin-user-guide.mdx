...
<LargeImg src="/img/admin-guide/account-settings.png" alt="A screenshot of the Rafiki Admin application user interface displaying the &#x22;Account Settings&#x22; section. It shows two text fields: one to change an email address and one to change a password." />
...
<LargeImg src="/img/admin-guide/home.png" alt="Rafiki Admin application user interface welcome screen with navigation options like Home, Peers, Assets, Wallet Addresses, Webhooks, and more on the left sidebar." />
...
<LargeImg src="/img/admin-guide/peers.png" alt="A screenshot of the Rafiki Admin application user interface displaying the &#x22;Peers&#x22; section. It shows a table containing a peer with details including ILP address, asset, and outgoing HTTP endpoint. A &#x22;Create peer&#x22; button is in the top right." />

### Create peer

To create a new peer, select **Create Peer** from the main Peers page.

<LargeImg src="/img/admin-guide/create-peer.png" alt="A screenshot of the Rafiki Admin application user interface displaying the &#x22;Create Peer&#x22; section. It shows several text fields to configure in order to create a new peer. A &#x22;Create&#x22; button is in the lower right." />
...
<LargeImg src="/img/admin-guide/edit-peer.png" alt="A screenshot of the Rafiki Admin application user interface displaying the &#x22;Edit Peer&#x22; section. It shows several text fields configured for an existing peer. This page is used to view peer details, edit peer details, and delete a peer." />
...
<img src="/img/admin-guide/v1-beta/delete-peer.png" alt="A screenshot of the Rafiki Admin application user interface displaying the &#x22;Delete Peer&#x22; modal window." class="img-outline" style="max-width:400px" />
...
<LargeImg src="/img/admin-guide/assets.png" alt="A screenshot of the Rafiki Admin application user interface displaying the &#x22;Assets&#x22; section. It shows a table containing four assets with details including ID, asset code, asset scale, and withdrawal threshold. An &#x22;Add asset&#x22; button is in the top right." />

### Create asset

To create a new asset, select **Add Asset** from the main Assets page.

<LargeImg src="/img/admin-guide/create-asset.png" alt="A screenshot of the Rafiki Admin application user interface displaying the &#x22;Create Asset&#x22; section. It shows several text fields to configure in order to create a new asset. A &#x22;Create&#x22; button is in the lower right." />
...
<LargeImg src="/img/admin-guide/edit-asset.png" alt="A screenshot of the Rafiki Admin application user interface displaying the &#x22;Edit Asset&#x22; section. It shows several text fields configured for an existing asset. This page is used to view and edit asset details." />
...
<LargeImg src="/img/admin-guide/wallet-addresses.png" alt="A screenshot of the Rafiki Admin application user interface displaying the &#x22;Wallet Addresses&#x22; section. It shows a table containing four wallet addresses with details including URL of the address, public name, and status. A &#x22;Create wallet address&#x22; button is in the top right." />

### Create wallet address

To create a new wallet address, select **Create wallet address** from the main Wallet Address page.

<LargeImg src="/img/admin-guide/create-wallet-address.png" alt="A screenshot of the Rafiki Admin application user interface displaying the &#x22;Create Wallet Address&#x22; section. It shows several text fields to configure in order to create a new wallet address. A &#x22;Create&#x22; button is in the lower right." />
...
<LargeImg src="/img/admin-guide/edit-wallet-address.png" alt="A screenshot of the Rafiki Admin application user interface displaying the &#x22;Edit Wallet Address&#x22; section. It shows several text fields configured for an existing wallet address. This page is used to view and edit wallet address details." />
...
<LargeImg src="/img/admin-guide/payments.png" alt="A screenshot of the Rafiki Admin application user interface displaying the &#x22;Payments&#x22; section. It shows a table where payment details would be displayed including ID, payment type, payment state, and the date of the payment." />
