...
![Architecture diagram for Rafiki telemetry](/img/v1-beta/concepts-telemetry-architecture.png)
...
You can test the configuration in our [Local Playground](/v1-beta/integration/playground/overview) by providing the environment variables in the preceding table to `happy-life-backend` in the <LinkOut href="https://github.com/interledger/rafiki/blob/main/localenv/happy-life-bank/docker-compose.yml">`docker-compose.yml`</LinkOut> file.
