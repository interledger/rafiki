...
While you and your peer may run any implementation of an [Interledger connector](/v1-beta/integration/deployment/services/backend-service#interledger-connector) such as the <LinkOut href="https://github.com/interledger/interledgerjs">TypeScript implementation</LinkOut>, it is recommended to use Rafiki.
