...
<div class="overflow-table">
  ...
  | --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
  | [`backend`](/v1-beta/integration/deployment/services/backend-service)   | <ul><li>SPSP</li><li>Open Payments APIs</li><li>GraphQL Admin APIs</li><li>STREAM endpoint</li></ul> |
...
<img src="/img/v1-beta/localenv-databases.png" alt="Databases required to run Rafiki" style="max-width:300px" />
