...
All requests to the Backend Admin API must be authenticated using HTTP signatures. See [Backend service](/integration/deployment/services/backend-service#authentication-and-authorization) for more information.
