...
import BackEnv from '/src/content/docs/partials/backend-variables.mdx'
import AuthEnv from '/src/content/docs/partials/auth-variables.mdx'
import FrontEnv from '/src/content/docs/partials/frontend-variables.mdx'
import VarWarn from '/src/content/docs/partials/variables-warning.mdx'
