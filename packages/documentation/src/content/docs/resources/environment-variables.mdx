...
import BackEnv from '/src/content/docs/partials/_backend-variables.mdx'
import AuthEnv from '/src/content/docs/partials/_auth-variables.mdx'
import FrontEnv from '/src/content/docs/partials/_frontend-variables.mdx'
import VarWarn from '/src/content/docs/partials/_variables-warning.mdx'
