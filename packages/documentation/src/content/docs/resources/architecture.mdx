...
Rafiki is a collection of three services that run together. Each one can scale horizontally and is designed to support [multi-tenancy](/overview/concepts/multi-tenancy).
