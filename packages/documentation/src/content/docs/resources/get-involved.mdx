...
- **Join Our Community**:
  ...
  - Connect with us on <LinkOut href="https://interledger.slack.com">`interledger.slack.com`</LinkOut> in the `#rafiki` channel for real-time discussions
...
Ready to dive in? Here's how to review good first issues if you are new to open source development.

#### 1: Navigate to the issues tab

Go to <LinkOut href="https://github.com/interledger/rafiki/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22">good first issues</LinkOut> in the Rafiki repo on GitHub.
