...
| Value                                                                                                          | Description                                                                        |
| -------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| [`incoming_payment.created`](/integration/requirements/webhook-events/#incoming-payment-created)               | An incoming payment has been created.                                              |
...
| [`asset.liquidity_high`](/integration/requirements/webhook-events/#asset-liquidity-high)                       | Asset liquidity has exceeded defined threshold.                                 |
...
| [`peer.liquidity_high`](/integration/requirements/webhook-events/#peer-liquidity-high)                         | Peer liquidity has exceeded defined threshold.                                  |
