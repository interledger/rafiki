...
- Familiarity with general Rafiki concepts. The [intro to Rafiki overview](/intro-to-rafiki/overview) is a great place to start.
...
The Webhook Events page allows you to monitor and manage webhook events within your Rafiki instance. Webhook events in Rafiki are the main communication channel between you and your Rafiki instance. See [Webhook events](/integration/deploy-to-prod/endpoints/webhook-events) for more information about webhook events.
