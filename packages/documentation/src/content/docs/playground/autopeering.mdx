...
To use the Open Payments example in the <LinkOut href='https://rafiki.dev/playground/overview/#bruno--open-payments-apis'>Bruno API collection</LinkOut>, follow these steps:
...
<LinkOut href='https://loca.lt/mytunnelpassword'>
  loca.lt/mytunnelpassword
</LinkOut> or <LinkOut href='https://www.whatismyip.com/'>
  whatismyip.com
</LinkOut>
:::
