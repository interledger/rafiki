...
Puede obtener más información sobre la compensación en relación con ILP en los [documentos para desarrolladores de Interledger](https://interledger.org/developers/rfcs/peering-clearing-settling/).
