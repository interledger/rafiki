...
Un Payment Pointer es un tipo de dirección de billetera que funciona como un punto final de SPSP para facilitar el envío y la recepción de paquetes ILP. Rafiki asignará un Payment Pointer a cada una de las cuentas de sus clientes.
...
Consulte [Payment Pointers y direcciones de billetera](/es/overview/concepts/payment-pointers) para obtener más información.
