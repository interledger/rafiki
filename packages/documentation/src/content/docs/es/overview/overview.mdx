...
Rafiki is open-source software maintained by a dedicated team and freely available to any licensed <Tooltip content="A regulated entity that provides and maintains payment accounts for its customers" client:load>[account servicing entity](/es/overview/concepts/account-servicing-entity)</Tooltip> (ASE) wanting to implement Interledger and [Open Payments](#pagos-abiertos) on users' accounts.

:::tip[Try it out]
The [Local Playground](/es/integration/playground/overview) allows you to test Rafiki by running two mock account servicing entities that automatically peer with one another.
:::
...
[Learn more about Interledger](/es/overview/concepts/interledger)
...
[Learn more about Open Payments](/es/overview/concepts/open-payments)
