...
<details>
  ...
  in their peer liquidity account on your Rafiki instance. Your Rafiki instance
  can receive packets that total up to \$100.00 from Cloud Nine Wallet. When the
  \$100.00 is used up, Cloud Nine Wallet settles with you by sending \$100.00
  via the shared settlement mechanism outlined in your peering agreement. When
  you receive the funds, you reset their liquidity in Rafiki.
</details>
