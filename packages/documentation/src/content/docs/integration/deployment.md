...
| `ALL_ACCESS_INTERACTION`       | `true`                                                           | Specify whether grant requests including `read-all` and `list-all` actions should require interaction. In these requests, the client asks to read or list resources that they themselves did not create. |
