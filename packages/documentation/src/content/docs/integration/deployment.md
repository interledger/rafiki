...
| `AUTO_PEERING_SERVER_PORT`                            | `3005`                                                      | Port for the [auto-peering](/concepts/interledger-protocol/peering#auto-peering) server                                                           |
...
| `INSTANCE_NAME`                                       | `Rafiki`                                                    | Used to communicate the wallet/Rafiki name for [auto-peering](/concepts/interledger-protocol/peering#auto-peering)                                |
