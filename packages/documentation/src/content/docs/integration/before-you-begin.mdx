...
- Establish a mechanism for managing liquidity via [webhook events](#manage-liquidity-via-webhook-events)
...
Skip to the [exchange rate environment variables](#exchange-rate-environment-variables) for a summary of required variables.
...
For this example, assume your asset scale is 2. You'll charge a fixed fee of 100 (\$1.00) and a variable fee of 100 (1%).
...
## Manage liquidity via webhook events
