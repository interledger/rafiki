...
import BackEnv from '/src/content/docs/partials/_backend-variables-docker-compose.mdx'
import AuthEnv from '/src/content/docs/partials/_auth-variables-docker-compose.mdx'
import FrontEnv from '/src/content/docs/partials/_frontend-variables-docker-compose.mdx'
...
:::note
While Docker Compose could serve as a production deployment, it's an environment best suited for development and testing. For more information, refer to Docker's <LinkOut href='https://docs.docker.com/compose/intro/features-uses/#common-use-cases-of-docker-compose'>documentation</LinkOut> on common use cases.
:::
...
Before using the Compose file, you must update the variables with values relevant to your environment. Specifically, change the values enclosed in the brackets and substitute `newest-version` with the latest Rafiki <LinkOut href='https://github.com/interledger/rafiki/releases'>version</LinkOut>.
:::
