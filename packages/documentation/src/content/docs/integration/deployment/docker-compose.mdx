...
import BackEnv from '/src/content/docs/partials/backend-variables-docker-compose.mdx'
import AuthEnv from '/src/content/docs/partials/auth-variables-docker-compose.mdx'
import FrontEnv from '/src/content/docs/partials/frontend-variables-docker-compose.mdx'
