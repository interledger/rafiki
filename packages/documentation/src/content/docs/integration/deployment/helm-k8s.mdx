...
import BackEnv from '/src/content/docs/partials/backend-variables-helm.mdx'
import AuthEnv from '/src/content/docs/partials/auth-variables-helm.mdx'
import FrontEnv from '/src/content/docs/partials/frontend-variables-helm.mdx'
