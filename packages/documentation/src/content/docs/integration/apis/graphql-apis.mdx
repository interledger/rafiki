...
This API is complemented by the Rafiki Admin app, a frontend interface for Rafiki management that directly interacts with the Backend Admin API. Visit the [Rafiki Admin User Guide](/admin/admin-user-guide) for more information.
