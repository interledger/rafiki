...
The main communication channel between you and your Rafiki instance is composed of the [Backend Admin API](/apis/admin-api-overview) and a set of webhook events.
