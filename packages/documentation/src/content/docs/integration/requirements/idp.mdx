...
| ---------------------------------------------------- | ------------------------------- | ---------------------------------------------------------------- |
| <Badge text="GET" variant="note" size="medium"/>     | `/interact/{id}/{nonce}`        | [Start user interaction session](#establish-interaction-session) |
| <Badge text="GET" variant="note" size="medium"/>     | `/grant/{id}/{nonce}`           | [Look up grant information](#fetch-grant-information)            |
