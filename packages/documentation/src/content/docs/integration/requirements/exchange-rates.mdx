...
If you plan to support cross-currency transactions, you must specify from where your Rafiki instance will fetch current exchange rates. Tenants are responsible for setting their own rates and hosting them at their own endpoints.
