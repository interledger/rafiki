...
- Wallet address structure is determined by the ASE. Consider whether your chosen naming conventions could disclose personal data. For example, choosing to issue addresses using first and last names.
