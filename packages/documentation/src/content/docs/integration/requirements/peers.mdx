...
While you and your peer can run any implementation of an [Interledger connector](/integration/deployment/services/backend-service#interledger-connector) such as the <LinkOut href="https://github.com/interledger/interledgerjs">TypeScript implementation</LinkOut>, it's recommended to use Rafiki.
