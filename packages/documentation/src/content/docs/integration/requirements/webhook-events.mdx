...
| [`asset.liquidity_high`](#asset-liquidity-high) | Your asset liquidity has exceeded your defined threshold      |
...
Your asset liquidity for USD (asset scale: 2) exceeds \$10000.00.
  ...
  <Mermaid
    graph={`sequenceDiagram
      ...
      R->>ASE: Fires asset.liquidity_high event to webhook endpoint,<br/>asset: USD (scale: 2, id: "abc")
      ASE->>R: Backend Admin API call: CreateAssetLiquidityWithdrawal
...
The `asset.liquidity_high` event indicates that an asset's liquidity has exceeded your predefined liquidity threshold. You may want to assess if adjustments to your liquidity thresholds or asset allocation strategies are needed. For example, this could occur during cross-currency transfers or significant asset inflows.
...
| [`peer.liquidity_high`](#peer-liquidity-high) | Your peer liquidity has exceeded your defined threshold      |
...
The liquidity for your peer, Happy Life Bank, exceeds \$10000.00 USD.
  ...
  <Mermaid
    graph={`sequenceDiagram
      ...
      R->>ASE: Fires peer.liquidity_high event to webhook endpoint,<br/>peer: Happy Life Bank (asset: "USD", scale: 2, id: "abc")
      ASE->>R: Backend Admin API call: CreatePeerLiquidityWithdrawal
...
The `peer.liquidity_high` event indicates that a peer's liquidity has exceeded your predefined liquidity threshold. This typically happens when the peer is sending payments, which increases their available liquidity within the system. However, this also reflects a growing debt obligation they owe to the other peer. Use this information to manage your risk and assess whether further actions, such as adjusting credit limits or requesting settlements, are required.
