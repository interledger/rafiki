...
You can charge fees on top of estimated network fees to facilitate transfers. Each asset you support can have a different fee structure and you can specify both fixed and variable fees per asset.
