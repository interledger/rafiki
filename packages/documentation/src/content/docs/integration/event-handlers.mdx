...
In addition, the `CreateIncomingPaymentWithdrawal` supports two-phase transfers [see more](/reference/glossary#two-phase-transfers).
...
In addition, the `CreateOutgoingPaymentWithdrawal` supports two-phase transfers [see more](/reference/glossary#two-phase-transfers).
