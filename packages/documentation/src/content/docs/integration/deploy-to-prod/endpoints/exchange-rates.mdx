...
You may also add fees via the Rafiki Admin application. See the [Rafiki Admin application user guide](/admin/admin-user-guide/#assets) for more information on configuring asset fees.
