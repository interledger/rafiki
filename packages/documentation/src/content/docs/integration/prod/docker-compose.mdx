...
This guide will map Rafiki services to one domain and multiple subdomains.  Using the DNS host of your choice, set up your domain and subdomains according to the following convention: 
...
This example deployment uses the `e2-standard-2` VM on Google Cloud Platform with the following specifications: 
...
:::note
You must change the values in the examples appropriate for your environment.
:::
