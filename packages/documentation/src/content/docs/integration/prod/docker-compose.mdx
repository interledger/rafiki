...
Update the following compose file with values relevant to your environment and system:

:::note
You must change the values enclosed within curly brackets {} of the following compose file.
:::
