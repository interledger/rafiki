...
<LargeImg
  src='/img/admin-guide/home-pre.png'
  alt='A screenshot of the Rafiki Admin application user interface displaying the API credentials screen before the credentials have been entered. It shows two text fields: one for tenant ID and one for API secret, and a navigation menu showing only the Home option.'
/>
...
<LargeImg
  src='/img/admin-guide/home-post.png'
  alt='A screenshot of the Rafiki Admin application user interface displaying the API credentials screen after the credentials have been entered. It shows a success message, a "Clear Credentials" button, and the full navigation menu.'
/>
...
:::note
Ory Kratos and Rafiki Admin should be hosted on the same top-level domain. Hosting Kratos on a subdomain is not recommended by Ory, but if you choose this approach, ensure you follow the guidelines provided in the <LinkOut href="https://www.ory.sh/docs/kratos/debug/csrf#running-on-separate-subdomains">Kratos documentation</LinkOut>.
:::
...
<LargeImg
  src='/img/admin-guide/account-settings-recovery.png'
  alt='A screenshot of the Rafiki Admin application user interface displaying the "Account Settings" section after using an invitation link. It shows a success message indicating the account was recovered, along with two text fields: one to change an email address and one to change a password.'
/>
...
<LargeImg
  ...
  alt='A screenshot of the Rafiki Admin application user interface displaying the home page with API credentials configured. It shows the full left-hand navigation menu including Home, Tenants, Assets, Peers, Wallet Addresses, Webhook Events, Payments, and Account Settings.'
/>
...
<LargeImg
  src='/img/admin-guide/tenants.png'
  alt='A screenshot of the Rafiki Admin application user interface displaying the "Tenants" section. It shows a table containing tenants with details including Public name, Email, and Status. An "Add tenant" button is in the top right.'
/>
...
<LargeImg
  src='/img/admin-guide/create-tenant.png'
  alt='A screenshot of the Rafiki Admin application user interface displaying the "Create Tenant" section. It shows several text fields to configure in order to create a new tenant. A "Create" button is in the lower right.'
/>
...
<LargeImg
  src='/img/admin-guide/edit-tenant.png'
  alt='A screenshot of the Rafiki Admin application user interface displaying the "Edit Tenant" section. It shows several text fields configured for an existing tenant. This page is used to view and edit tenant details.'
/>
...
<img
  src='/img/admin-guide/delete-tenant.png'
  alt='A screenshot of the Rafiki Admin app user interface displaying the "Delete Tenant" modal window.'
  class='img-outline'
...
<img
  src='/img/admin-guide/delete-asset.png'
  alt='A screenshot of the Rafiki Admin app user interface displaying the "Delete Asset" modal window.'
  class='img-outline'
  style='max-width:400px'
/>
...
<img
  ...
  alt='A screenshot of the Rafiki Admin app user interface displaying the "Delete Peer" modal window.'
  class='img-outline'
  style='max-width:400px'
/>
...
<LargeImg
  ...
  alt='A screenshot of the Rafiki Admin application user interface displaying the "Payments" section. It shows an empty table  with a "No payments found" message, along with filter fields at the top for payment type and wallet address ID.'
/>
