...
Alternatively, assets can be added through the [Rafiki Admin](/admin/admin-user-guide/#assets) application. Navigate to the main Assets page and then configure the asset code and scale.
