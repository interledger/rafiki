...
| `COOKIE_KEY`             | `auth.cookieKey.secretKeyRef.key`                   | `COOKIE_KEY`                | The <LinkOut href="https://koajs.com/#app-keys-">koa KeyGrip key</LinkOut> that is used to sign cookies for an interaction session.                                                                                                                                                                                                                                |
