...
export type ResolversTypes = {
  ...
  BasePayment: ResolversTypes['IncomingPayment'] | ResolversTypes['OutgoingPayment'] | ResolversTypes['Payment'];
  ...
  CreatePeerByUrlInput: ResolverTypeWrapper<Partial<CreatePeerByUrlInput>>;
  CreatePeerByUrlMutationResponse: ResolverTypeWrapper<Partial<CreatePeerByUrlMutationResponse>>;
  ...
  Model: ResolversTypes['Asset'] | ResolversTypes['Fee'] | ResolversTypes['IncomingPayment'] | ResolversTypes['OutgoingPayment'] | ResolversTypes['Payment'] | ResolversTypes['PaymentPointer'] | ResolversTypes['PaymentPointerKey'] | ResolversTypes['Peer'] | ResolversTypes['WebhookEvent'];
  Mutation: ResolverTypeWrapper<{}>;
  MutationResponse: ResolversTypes['AssetMutationResponse'] | ResolversTypes['CreatePaymentPointerKeyMutationResponse'] | ResolversTypes['CreatePaymentPointerMutationResponse'] | ResolversTypes['CreatePeerByUrlMutationResponse'] | ResolversTypes['CreatePeerMutationResponse'] | ResolversTypes['DeletePeerMutationResponse'] | ResolversTypes['LiquidityMutationResponse'] | ResolversTypes['PaymentPointerWithdrawalMutationResponse'] | ResolversTypes['RevokePaymentPointerKeyMutationResponse'] | ResolversTypes['SetFeeResponse'] | ResolversTypes['TransferMutationResponse'] | ResolversTypes['TriggerPaymentPointerEventsMutationResponse'] | ResolversTypes['UpdatePaymentPointerMutationResponse'] | ResolversTypes['UpdatePeerMutationResponse'];
...
export type ResolversParentTypes = {
  ...
  BasePayment: ResolversParentTypes['IncomingPayment'] | ResolversParentTypes['OutgoingPayment'] | ResolversParentTypes['Payment'];
  ...
  CreatePeerByUrlInput: Partial<CreatePeerByUrlInput>;
  CreatePeerByUrlMutationResponse: Partial<CreatePeerByUrlMutationResponse>;
  ...
  Model: ResolversParentTypes['Asset'] | ResolversParentTypes['Fee'] | ResolversParentTypes['IncomingPayment'] | ResolversParentTypes['OutgoingPayment'] | ResolversParentTypes['Payment'] | ResolversParentTypes['PaymentPointer'] | ResolversParentTypes['PaymentPointerKey'] | ResolversParentTypes['Peer'] | ResolversParentTypes['WebhookEvent'];
  Mutation: {};
  MutationResponse: ResolversParentTypes['AssetMutationResponse'] | ResolversParentTypes['CreatePaymentPointerKeyMutationResponse'] | ResolversParentTypes['CreatePaymentPointerMutationResponse'] | ResolversParentTypes['CreatePeerByUrlMutationResponse'] | ResolversParentTypes['CreatePeerMutationResponse'] | ResolversParentTypes['DeletePeerMutationResponse'] | ResolversParentTypes['LiquidityMutationResponse'] | ResolversParentTypes['PaymentPointerWithdrawalMutationResponse'] | ResolversParentTypes['RevokePaymentPointerKeyMutationResponse'] | ResolversParentTypes['SetFeeResponse'] | ResolversParentTypes['TransferMutationResponse'] | ResolversParentTypes['TriggerPaymentPointerEventsMutationResponse'] | ResolversParentTypes['UpdatePaymentPointerMutationResponse'] | ResolversParentTypes['UpdatePeerMutationResponse'];
...
export type CreatePeerByUrlMutationResponseResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreatePeerByUrlMutationResponse'] = ResolversParentTypes['CreatePeerByUrlMutationResponse']> = {
  code?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  ...
  createPeerByUrl?: Resolver<ResolversTypes['CreatePeerByUrlMutationResponse'], ParentType, ContextType, RequireFields<MutationCreatePeerByUrlArgs, 'input'>>;
...
export type MutationResponseResolvers<ContextType = any, ParentType extends ResolversParentTypes['MutationResponse'] = ResolversParentTypes['MutationResponse']> = {
  __resolveType: TypeResolveFn<'AssetMutationResponse' | 'CreatePaymentPointerKeyMutationResponse' | 'CreatePaymentPointerMutationResponse' | 'CreatePeerByUrlMutationResponse' | 'CreatePeerMutationResponse' | 'DeletePeerMutationResponse' | 'LiquidityMutationResponse' | 'PaymentPointerWithdrawalMutationResponse' | 'RevokePaymentPointerKeyMutationResponse' | 'SetFeeResponse' | 'TransferMutationResponse' | 'TriggerPaymentPointerEventsMutationResponse' | 'UpdatePaymentPointerMutationResponse' | 'UpdatePeerMutationResponse', ParentType, ContextType>;
  code?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  success?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
};
...
export type Resolvers<ContextType = any> = {
  ...
  CreatePeerByUrlMutationResponse?: CreatePeerByUrlMutationResponseResolvers<ContextType>;
