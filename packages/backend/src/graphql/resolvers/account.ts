...
export const createAccount: MutationResolvers<ApolloContext>['createAccount'] =
  async (
    parent,
    args,
    ctx
...
export const triggerAccountEvents: MutationResolvers<ApolloContext>['triggerAccountEvents'] =
  async (
    parent,
    args,
    ctx
