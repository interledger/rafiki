...
export interface components {
  schemas: {
    ...
    "incoming-payment": {
      ...
      incomingAmount?: external["https://raw.githubusercontent.com/interledger/open-payments/02a6d505d79124cce776054df89e28f02c8e5d59/openapi/schemas.yaml"]["components"]["schemas"]["amount"];
      /** @description The total amount that has been paid into the payment pointer under this incoming payment. */
      receivedAmount: external["https://raw.githubusercontent.com/interledger/open-payments/02a6d505d79124cce776054df89e28f02c8e5d59/openapi/schemas.yaml"]["components"]["schemas"]["amount"];
      /**
       * Format: date-time
    ...
    "outgoing-payment": {
      ...
      sentAmount: external["https://raw.githubusercontent.com/interledger/open-payments/02a6d505d79124cce776054df89e28f02c8e5d59/openapi/schemas.yaml"]["components"]["schemas"]["amount"];
