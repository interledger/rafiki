...
export interface components {
  schemas: {
    ...
    "incoming-payment": {
      ...
      incomingAmount?: external["https://raw.githubusercontent.com/interledger/open-payments/62c4b4a9875e3adaa21f89f597e88db43016fe0b/openapi/schemas.yaml"]["components"]["schemas"]["amount"];
      /** @description The total amount that has been paid into the payment pointer under this incoming payment. */
      receivedAmount: external["https://raw.githubusercontent.com/interledger/open-payments/62c4b4a9875e3adaa21f89f597e88db43016fe0b/openapi/schemas.yaml"]["components"]["schemas"]["amount"];
      /**
       * Format: date-time
    ...
    "outgoing-payment": {
      ...
      sentAmount: external["https://raw.githubusercontent.com/interledger/open-payments/62c4b4a9875e3adaa21f89f597e88db43016fe0b/openapi/schemas.yaml"]["components"]["schemas"]["amount"];
