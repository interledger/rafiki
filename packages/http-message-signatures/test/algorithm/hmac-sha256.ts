...
describe('hmac-sha256', () => {
    ...
    describe('internal tests', () => {
        ...
        const sig = Buffer.from('f7bc83f430538424b13298e6aa6fb143ef4d59a14946175997479dbc2d1a3cd8', 'hex');
    ...
    describe('specification examples', () => {
        const testSharedSecret = Buffer.from('uzvJfB4u3N0Jy4T7NZ75MDVcr8zSTInedJtkgcu46YW4XByzNJjxBdtjUkdJPBtbmHhIDi6pcl8jsasjlTMtDQ==', 'base64');
        const expectedSig = Buffer.from('fN3AMNGbx0V/cIEKkZOvLOoC3InI+lM2+gTv22x3ia8=', 'base64');
        const signatureInput = '"@authority": example.com\n' +
