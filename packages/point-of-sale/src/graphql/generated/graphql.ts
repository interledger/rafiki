...
export type GetWalletAddress = { __typename?: 'Query', walletAddressByUrl?: { __typename?: 'WalletAddress', id: string, incomingPayments?: { __typename?: 'IncomingPaymentConnection', edges: Array<{ __typename?: 'IncomingPaymentEdge', cursor: string, node: { __typename?: 'IncomingPayment', id: string, url: string, walletAddressId: string, senderWalletAddress?: string | null, state: IncomingPaymentState, metadata?: any | null, expiresAt: string, createdAt: string, incomingAmount?: { __typename?: 'Amount', assetCode: string, assetScale: number, value: bigint } | null, receivedAmount: { __typename?: 'Amount', assetCode: string, assetScale: number, value: bigint }, tenant: { __typename?: 'Tenant', id: string, apiSecret: string, createdAt: string, settings: Array<{ __typename?: 'TenantSetting', key: TenantSettingKey, value: string }> } } }>, pageInfo: { __typename?: 'PageInfo', endCursor?: string | null, hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null } } | null } | null };
