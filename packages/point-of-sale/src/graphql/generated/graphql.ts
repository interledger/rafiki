...
export type GetWalletAddress = { __typename?: 'Query', walletAddressByUrl?: { __typename?: 'WalletAddress', id: string, incomingPayments?: { __typename?: 'IncomingPaymentConnection', edges: Array<{ __typename?: 'IncomingPaymentEdge', cursor: string, node: { __typename?: 'IncomingPayment', id: string, url: string, walletAddressId: string, senderWalletAddress?: string | null, client?: string | null, state: IncomingPaymentState, expiresAt: string, createdAt: string, tenantId?: string | null, incomingAmount?: { __typename?: 'Amount', assetCode: string, assetScale: number, value: bigint } | null, receivedAmount: { __typename?: 'Amount', assetCode: string, assetScale: number, value: bigint } } }>, pageInfo: { __typename?: 'PageInfo', endCursor?: string | null, hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null } } | null } | null };
